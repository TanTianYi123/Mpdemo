...
public interface AlarmMapper {
    ...
    AlarmSettings getAlarmSettingsEntity(String monitorClass);
    ...
    public List<AlarmSettings> getAlarmSettingsByFeatures(String feature);
    ...
    public int insertAlarmEntity(AlarmSettings alarmSettingsEntity);
    ...
    @Update("UPDATE `alarm_settings` " +
            ...
            "`message` = #{message} " +
            "WHERE `id`=#{id}")
    public int updateAlarmSetting(AlarmSettings alarmSettingsEntity);
    ...
    void insertalarmRecords(AlarmRecords alarmRecordentity);
    ...
    public List<AlarmRecords> getAllAlarmRecords();
    ...
    public List<AlarmRecords> getAlarmRecordsByFeature(HashMap<String,String> features);
}
