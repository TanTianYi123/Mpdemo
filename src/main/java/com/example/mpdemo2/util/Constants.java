...
public interface Constants {
	...
	String ADDEDGESETTING = "addEdgeSetting";
	String SUCCESS = "success";
	String ALLDETAIL ="allDetail";
	String PERSONALCENTER="personal-center";
	String REASSEMBLE ="reAssemble";
	String WAIT = "wait";
	String LISTEDGENODES = "ListEdgeNode";
	String ADDDEPLOYMENTS = "addDeployments";
	...
	String LISTDEPLOYMENTS = "allDeployments";
